...
def main():
    ...
    for i in range(0, 5):
        if i == 0:
            # For Cluster IC 2391
            print "Cluster IC 2391"
            plt.suptitle("Cluster IC 2391", fontsize='22')
            start = 0
            stop = 11 + 1
            s_start = 0 # for single stars
            s_stop = 20 + 1
        if i == 1:
            # For Cluster NGC 6475
            print "Cluster NGC 6475"
        ...
        if i == 3:
            ...
            print "Cluster NGC 3532"
            plt.suptitle("Cluster NGC 3532", fontsize='22')
            start = 48
            stop = 65 + 1
        if i == 4:
            # For Cluster IC 2602
            print "Cluster IC 2602"
        ...
        # J-band for binaries.
        plt.subplot(1, 3, 1)
        plt.plot(J_age[start:stop], b_absJ[start:stop], 'o', color='g')
        ...
        # H-band for binaries
        plt.subplot(1, 3, 2)
        plt.plot(H_age[start:stop], b_absH[start:stop], 'o', color='g')
        ...
        # K-band for binaries
        plt.subplot(1, 3, 3)
        plt.plot(K_age[start:stop], b_absK[start:stop], 'o', color='g')
