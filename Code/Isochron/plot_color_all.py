...
def main():
    ...
    plt.plot(s_absJ - s_absK, s_absK, 'x', color='g')
    # Plotting IR Photometry
    plt.plot(J_IR_photo-K_IR_photo, K_IR_photo, 'x', color='c')
    plt.plot(J_2-K_2, K_2, 'x', color='c')
    # Plotting Isochrones
    plt.plot(m_j - m_k, m_k, color='k')
    plt.plot(IC_2602_j - IC_2602_k, IC_2602_k, linestyle='--', color='k')
    plt.plot(NGC_3532_j - NGC_3532_k, NGC_3532_k, linestyle='--', color='k')
    
    plt.subplot(122)
    # Plotting Single Stars
    plt.plot(s_absH - s_absK, s_absK, 'x', color='g')
    # Plotting IR Photometry
    plt.plot(H_IR_photo-K_IR_photo, K_IR_photo, 'x', color='c')
    # Plotting Isochrones
    plt.plot(m_h - m_k, m_k, color='k')
    plt.plot(IC_2602_h - IC_2602_k, IC_2602_k, linestyle='--', color='k')
    plt.plot(NGC_3532_h - NGC_3532_k, NGC_3532_k, linestyle='--', color='k')
    ...
    for i in range(start+1, stop, 2):
        ...
        if comp_names[i] in upper_lim_list:
            ...
            plt.plot(KJ[i], b_absK[i], 'v', color='m', label="IC 2391 C")
        else:
            plt.plot(KJ[i], b_absK[i], 'd', color='r', label="IC 2391 C")
    
    
    #plt.plot(m_j - m_k, m_k, color='k')
    #plt.plot(IC_2602_j - IC_2602_k, IC_2602_k, color='g')
    #plt.plot(NGC_3532_j - NGC_3532_k, NGC_3532_k, color='r')
    ...
    for i in range(start, stop, 2):
        ...
        plt.plot(KH[i], b_absK[i], 'o', color='b', label="IC 2391 P")
    for i in range(start+1, stop, 2):
        plt.errorbar(KH[i], b_absK[i], xerr=(b_DelK[i]**2 + b_DelH[i]**2 + 2*0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        #plt.plot(KH[i], b_absK[i], 'd', color='r', label="IC 2391 C")
        
        if comp_names[i] in std_avg_list and comp_names[i] not in stat_arg_list:
            plt.plot(KH[i], b_absK[i], '<', color='r', label="IC 2391 C")
        elif comp_names[i] not in std_avg_list and comp_names[i] in stat_arg_list:
            plt.plot(KH[i], b_absK[i], '>', color='r', label="IC 2391 C")
        elif comp_names[i] in std_avg_list and comp_names[i] in stat_arg_list:
            plt.plot(KH[i], b_absK[i], 'v', color='m', label="IC 2391 C")
        else:
            plt.plot(KH[i], b_absK[i], 'd', color='r', label="IC 2391 C")
        
    #plt.plot(KH[start:stop:2], b_absK[start:stop:2], 'o', color='b', label="IC 2391 P")
    #plt.plot(KH[start+1:stop:2], b_absK[start+1:stop:2], 'd', color='r', label="IC 2391 C")

    
    #plt.plot(m_h - m_k, m_k, color='k')
    #plt.plot(IC_2602_h - IC_2602_k, IC_2602_k, color='g')
    #plt.plot(NGC_3532_h - NGC_3532_k, NGC_3532_k, color='r')
    plt.gca().invert_yaxis()
    plt.ylabel("K Mag.", fontsize='16')
    ...
    for i in range(start, stop, 2):
        plt.errorbar(KJ[i], b_absK[i], xerr=(0.01**2 + 0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        plt.plot(KJ[i], b_absK[i], 'o', color='b', label='NGC 6474 P')
    for i in range(start+1, stop, 2):
        plt.errorbar(KJ[i], b_absK[i], xerr=(b_DelK[i]**2 + b_DelJ[i]**2 + 2*0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        #plt.plot(KJ[i], b_absK[i], 'd', color='r', label='NGC 6474 C')
    ...
    #plt.plot(KJ[start:stop:2], b_absK[start:stop:2], 'o', color='b', label='NGC 6474 P')
    #plt.plot(KJ[start+1:stop:2], b_absK[start+1:stop:2], 'd', color='r', label='NGC 6474 C')
    ...
    for i in range(start, stop, 2):
        plt.errorbar(KH[i], b_absK[i], xerr=(0.01**2 + 0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        plt.plot(KH[i], b_absK[i], 'o', color='b', label='NGC 6474 P')
    for i in range(start+1, stop, 2):
        plt.errorbar(KH[i], b_absK[i], xerr=(b_DelK[i]**2 + b_DelH[i]**2 + 2*0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        #plt.plot(KH[i], b_absK[i], 'd', color='r', label='NGC 6474 C')
    ...
    #plt.plot(KH[start:stop:2], b_absK[start:stop:2], 'o', color='b', label='NGC 6474 P')
    #plt.plot(KH[start+1:stop:2], b_absK[start+1:stop:2], 'd', color='r', label='NGC 6474 C')
    ...
    for i in range(start, stop, 2):
        plt.errorbar(KJ[i], b_absK[i], xerr=(0.01**2 + 0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        plt.plot(KJ[i], b_absK[i], 'o', color='b', label='NGC 2451 P')
    for i in range(start+1, stop, 2):
        plt.errorbar(KJ[i], b_absK[i], xerr=(b_DelK[i]**2 + b_DelJ[i]**2 + 2*0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        #plt.plot(KJ[i], b_absK[i], 'd', color='r', label='NGC 2451 C')
    ...
    #plt.plot(KJ[start:stop:2], b_absK[start:stop:2], 'o', color='b', label='NGC 2451 P')
    ...
    for i in range(start, stop, 2):
        plt.errorbar(KH[i], b_absK[i], xerr=(0.01**2 + 0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        plt.plot(KH[i], b_absK[i], 'o', color='b', label='NGC 2451 P')
    for i in range(start+1, stop, 2):
        plt.errorbar(KH[i], b_absK[i], xerr=(b_DelK[i]**2 + b_DelH[i]**2 + 2*0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        #plt.plot(KH[i], b_absK[i], 'd', color='r', label='NGC 2451 C')
    ...
    #plt.plot(KH[start:stop:2], b_absK[start:stop:2], 'o', color='b', label='NGC 2451 P')
    ...
    for i in range(start, stop, 2):
        plt.errorbar(KJ[i], b_absK[i], xerr=(0.01**2 + 0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        plt.plot(KJ[i], b_absK[i], 'o', color='b', label='NGC 3532 P')
    for i in range(start+1, stop, 2):
        plt.errorbar(KJ[i], b_absK[i], xerr=(b_DelK[i]**2 + b_DelJ[i]**2 + 2*0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        #plt.plot(KJ[i], b_absK[i], 'd', color='r', label='NGC 3532 C')
    ...
    #plt.plot(KJ[start:stop:2], b_absK[start:stop:2], 'o', color='b', label='NGC 3532 P')
    #plt.plot(KJ[start+1:stop:2], b_absK[start+1:stop:2], 'd', color='r', label='NGC 3532 C')
    ...
    for i in range(start, stop, 2):
        plt.errorbar(KH[i], b_absK[i], xerr=(0.01**2 + 0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        plt.plot(KH[i], b_absK[i], 'o', color='b', label='NGC 3532 P')
    for i in range(start+1, stop, 2):
        plt.errorbar(KH[i], b_absK[i], xerr=(b_DelK[i]**2 + b_DelH[i]**2 + 2*0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        #plt.plot(KH[i], b_absK[i], 'd', color='r', label='NGC 3532 C')
    ...
    #plt.plot(KH[start:stop:2], b_absK[start:stop:2], 'o', color='b', label='NGC 3532 P')
    #plt.plot(KH[start+1:stop:2], b_absK[start+1:stop:2], 'd', color='r', label='NGC 3532 C')
    ...
    for i in range(start, stop, 2):
        plt.errorbar(KJ[i], b_absK[i], xerr=(0.01**2 + 0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        plt.plot(KJ[i], b_absK[i], 'o', color='b', label='IC 2602 P')
    for i in range(start+1, stop, 2):
        plt.errorbar(KJ[i], b_absK[i], xerr=(b_DelK[i]**2 + b_DelJ[i]**2 + 2*0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        #plt.plot(KJ[i], b_absK[i], 'd', color='r', label='IC 2602 C')
    ...
    #plt.plot(KJ[start:stop:2], b_absK[start:stop:2], 'o', color='b', label='IC 2602 P')
    #plt.plot(KJ[start+1:stop:2], b_absK[start+1:stop:2], 'd', color='r', label='IC 2602 C')
    ...
    for i in range(start, stop, 2):
        plt.errorbar(KH[i], b_absK[i], xerr=(0.01**2 + 0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        plt.plot(KH[i], b_absK[i], 'o', color='b', label='IC 2602 P')
    for i in range(start+1, stop, 2):
        plt.errorbar(KH[i], b_absK[i], xerr=(b_DelK[i]**2 + b_DelH[i]**2 + 2*0.01**2)**.5, yerr=0.01, fmt='.', color='k')
        #plt.plot(KH[i], b_absK[i], 'd', color='r', label='IC 2602 C')
    ...
    #plt.plot(KH[start:stop:2], b_absK[start:stop:2], 'o', color='b', label='IC 2602 P')
    #plt.plot(KH[start+1:stop:2], b_absK[start+1:stop:2], 'd', color='r', label='IC 2602 C')
