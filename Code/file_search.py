...
def file_search(fil):
    path = '/Users/ppkantorski/Documents/Research/Duchene/Datasets/Feb17/*/K/*/*.fits'
...
def max_flux(name, path = '/Users/ppkantorski/Documents/Research/Duchene/Datasets/*/*/K/*/'):
    
    full_file = file_search(name, path)
    
    file = pyfits.open(full_file)
    image = file[0].data
